...
function create_validation_success_screen() {
    ...
    instruction.innerHTML += "<header class=\"form__header\">" +
        ...
        "</header>" +
        "<button class=\"form__button\" type=\"button\" onclick=\"navigate_tasks()\"> Continue </button>";
    document.body.appendChild(instruction);
}
...
function create_survey() {
    ...
    survey.innerHTML += "<header class=\"form__header\">" +
                        ...
                        "</header>" +
                        "<form>" +
                            "<select id='age-selector' required>" +
                            ...
                            "</select>" +
                            "</br>" +
                            "<button class=\"form__button\" type=\"button\" onclick = \"clear_canvas()\"> Bye Bye! </button>" +
