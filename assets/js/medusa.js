...
var simple_paradigm_settings = {
    ...
    num_trials: 1,
    fixation_rest_time: 10, // amount of time 'target' will appear on screen with each trial, in ms
    dot_show_time: 50    // amount of time dot will appear on screen with each trial, in ms
...
var massvis_paradigm_settings = {
    ...
    spacing: 10,
    num_trials: 1,
    fixation_rest_time: 10, // amount of time fixation cross will appear on screen with each trial, in ms
    image_show_time: 10   // amount of time the image will appear on screen with each trial, in ms
